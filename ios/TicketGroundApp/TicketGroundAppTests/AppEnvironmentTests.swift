...
final class AppEnvironmentTests: XCTestCase {
    ...
    func testRouteAliasesAndInventory() {
        ...
        XCTAssertEqual(AppRoute.queue(slug: "queue").classification.connectivity, .externalGate)
        XCTAssertEqual(AppRoute.booking(slug: "booking").classification.connectivity, .externalGate)
        XCTAssertNil(RouteResolver.resolve(path: "/admin"))
