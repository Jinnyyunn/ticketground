...
test("admin seat designer is replaced by the clean-room v2 editor", async () => {
  ...
  const editorFiles = ["seat-designer-v2.tsx", "reference-start.tsx", "toolbar.tsx", "inspector.tsx", "service-credentials-panel.tsx", "object-factory.ts", "object-transform.ts", "canvas-objects.tsx"];
