...
const help: Readonly<Record<ToolMode, ToolHelp>> = {
  ...
  node: { title: "노드", instructions: ["노드를 드래그하여 이동합니다.", "변을 더블클릭하면 노드가 추가되고 노드를 더블클릭하면 삭제됩니다."] },
  ...
  tableRectangular: { title: "직사각형 테이블", instructions: ["드래그하여 테이블을 배치합니다."], defaults: [{ label: "크기", value: "120 × 36 pt" }, { label: "위 / 아래", value: "4 / 4" }, { label: "왼쪽 / 오른쪽", value: "0 / 0" }] },
