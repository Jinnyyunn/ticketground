  ...
  return (
    <TicketingPageShell>
      <section className="ticketground-container py-10">
        <div className="rounded-[12px] border border-[#eee] p-7">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <h1 className="mt-4 text-[30px] font-bold text-[#29292d]">예매가 완료되었습니다</h1>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_340px]">
          <article className="overflow-hidden rounded-[12px] border border-[#29292d] bg-white shadow-sm">
            <div className="bg-[#29292d] p-6 text-white">
              <p className="text-[13px] font-bold text-[#ffe92e]">CLEAN TICKET</p>
              <h2 className="mt-2 text-[26px] font-bold">{reservation.showTitle}</h2>
              ...
              <dl className="grid gap-4 text-[15px]">
                {[
                  ...
                  <div key={label} className="grid gap-1">
                    ...
                    <dd className="font-bold text-[#29292d]">{value}</dd>
                  </div>
                ))}
              </dl>
          ...
          <aside className="h-fit rounded-[12px] border border-[#eee] p-5">
            ...
            <Link href={`/transfer?reservation=${reservation.id}&seat=${encodeURIComponent(seats)}`} className="mt-3 flex h-11 items-center justify-center rounded-[8px] border border-[#ddd] text-[14px] font-bold">
              동반자 티켓 양도
            </Link>
