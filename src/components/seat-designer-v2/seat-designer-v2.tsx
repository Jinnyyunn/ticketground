    ...
    >
      ...
      {inspectorOpen && (
        <div className="fixed inset-y-[46px] right-0 z-[60] flex w-[min(336px,92vw)] flex-col bg-[var(--editor-surface)] shadow-2xl lg:hidden">
          <button type="button" title="속성 패널 닫기" className="absolute right-0 top-0 z-10 grid size-11 place-items-center rounded border border-[var(--editor-border)] bg-[var(--editor-surface)] shadow-sm hover:bg-[var(--editor-hover)]" onClick={() => setInspectorOpen(false)}><X className="size-4" /></button>
