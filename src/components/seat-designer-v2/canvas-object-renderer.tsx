...
export function renderCanvasObject(object: ChartObject, selectedSeatIds: readonly string[], showLabels: boolean): ReactNode {
  ...
  if (object.type === "booth") return <g transform={object.rotation ? `rotate(${object.rotation} ${object.x + object.width / 2} ${object.y + object.height / 2})` : undefined}><rect x={object.x} y={object.y} width={object.width} height={object.height} rx="2" fill="var(--editor-booth)" stroke="var(--editor-seat-stroke)" /><text x={object.x + object.width / 2} y={object.y + object.height / 2 + 4} textAnchor="middle" fontSize="11" fill="var(--editor-canvas-foreground)">부스</text></g>;
