  ...
  return (
    <div className="flex min-h-0 flex-1">
      ...
      <main className="relative min-w-0 flex-1 overflow-hidden bg-[var(--editor-surface)]">
        ...
        <svg className={`size-full touch-none ${props.spacePressed || state.tool === "hand" ? "cursor-grab" : ""}`} data-testid="seat-designer-v2-canvas" onPointerDown={props.pointerDown} onPointerMove={props.pointerMove} onPointerUp={props.pointerUp} onDoubleClick={props.editNode} onContextMenu={props.removeNode}>
