...
export function LoginHeroAside() {
  return (
    <aside className="flex min-h-[560px] flex-col gap-8 bg-ink p-8 text-on-ink lg:p-10">
      <div>
        ...
        <p className="mt-5 max-w-[360px] text-sm leading-loose text-on-ink/70">
      ...
      <div className="grid gap-3 rounded-lg bg-background/8 p-5">
        <p className="text-sm font-black text-on-ink">회원 기능 미리보기</p>
        <dl className="grid grid-cols-3 gap-3 text-center">
          <div>
            <dt className="text-xs text-on-ink/55">예매번호</dt>
            <dd className="mt-1 text-sm font-black">CTI</dd>
          </div>
          <div>
            <dt className="text-xs text-on-ink/55">QR</dt>
            <dd className="mt-1 text-sm font-black">20초</dd>
          </div>
          <div>
            <dt className="text-xs text-on-ink/55">재판매</dt>
            <dd className="mt-1 text-sm font-black">공식</dd>
          </div>
        </dl>
      </div>

      <ul className="mt-auto grid gap-3 text-sm font-bold text-on-ink/80">
        {perks.map((perk) => (
