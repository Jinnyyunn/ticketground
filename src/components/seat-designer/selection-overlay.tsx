...
import { objectBounds, resizeBoundsForRotatedPointer, type ObjectBounds } from "@/lib/seat-designer/transforms";
...
export function SelectionOverlay({
  ...
  const move = (event: PointerEvent<SVGCircleElement>) => {
    ...
    if (current.kind === "resize") {
      setLiveBounds(object.rotation
        ? resizeBoundsForRotatedPointer(point, current.bounds, initialCenter, current.corner, object.rotation)
        : resized(current.bounds, current.corner, point));
      return;
    }
